...
# Decompiled By JALAL KHAN 

# Youtube : https://youtube.com/channel/UCxsi4JIa6F5KU9o1QC

# uncompyle6 version 

# Original written By JALAL KHAN

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'JALAL'

__copyright = 'NLS rights reserved . Copyright  JALAL KHAN'
...
logo = """
 ...
 __  / / __ `/ / __ `/ / 
/ /_/ / /_/ / / /_/ / /  
\____/\__,_/_/\__,_/_/                     Mister Mind 😈
                                                         Jalal khan-xd 😝
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [Sucessfull-Jalal]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [Sucessfull-Jalal] ' + k + c + user + '  |  ' + pass1
